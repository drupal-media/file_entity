...
class FileSettingsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['file_upload_wizard']['file_entity_file_upload_wizard_skip_file_type'] = array(
      ...
      '#default_value' => \Drupal::config('file_entity.settings')->get('file_upload_wizard_skip_file_type'),
    ...
    $form['file_upload_wizard']['file_entity_file_upload_wizard_skip_scheme'] = array(
      ...
      '#default_value' => \Drupal::config('file_entity.settings')->get('file_upload_wizard_skip_scheme'),
    ...
    $form['file_upload_wizard']['file_entity_file_upload_wizard_skip_fields'] = array(
      ...
      '#default_value' => \Drupal::config('file_entity.settings')->get('file_upload_wizard_skip_fields'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('file_entity.settings')
      ->set('max_filesize', $form_state['values']['file_entity_max_filesize'])
      ->set('default_allowed_extensions', $form_state['values']['file_entity_default_allowed_extensions'])
      ->set('alt', $form_state['values']['file_entity_alt'])
      ->set('title', $form_state['values']['file_entity_title'])
      ->set('file_upload_wizard_skip_file_type', $form_state['values']['file_entity_file_upload_wizard_skip_file_type'])
      ->set('file_upload_wizard_skip_scheme', $form_state['values']['file_entity_file_upload_wizard_skip_scheme'])
      ->set('file_upload_wizard_skip_fields', $form_state['values']['file_entity_file_upload_wizard_skip_fields'])
      ->save();
